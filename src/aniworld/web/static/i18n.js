  ...
  const STRINGS = {
    ...
    de: {
      ...
      "settings.enable_autosync_hint":
        "Prüft ausschließlich die auf der Auto-Sync-Seite ausgewählten AniWorld- und SerienStream-Serien und lädt fehlende Folgen nach Zeitplan.",
      "settings.autosync_new_only": "Auto-Sync: nur die neuen Episoden",
      "settings.autosync_new_only_hint":
        "Aus: alle vorhandenen Lücken füllen. An: nur Folgen oder Sprachfassungen laden, die nach dem Hinzufügen verfügbar wurden.",
      ...
      "autosync.how_note": "Auto-Sync prüft ausschließlich die Serien, die du unten hinzufügst. Jeder Eintrag gilt für genau eine Sprache und einen Zielpfad; AniWorld und SerienStream werden direkt geprüft. Es wird weder die komplette Bibliothek durchsucht noch auf die Seite „Neue Episoden“ gewartet.",
      "autosync.add_title": "Serie hinzufügen",
      "autosync.source": "Quelle",
      "autosync.language": "Sprache",
      "autosync.provider": "Hoster",
      "autosync.destination": "Zielpfad",
      "autosync.add_hint": "Beim Hinzufügen wird der aktuelle Stand der gewählten Sprachfassung gespeichert. Das startet noch keinen Download.",
      "autosync.tracked_title": "Aktuell gehaltene Serien",
      "autosync.series": "Serie",
      "autosync.language_destination": "Sprache / Ziel",
      "autosync.no_series": "Noch keine Serie hinzugefügt.",
      "autosync.active": "Aktiv",
      "autosync.paused": "Pausiert",
      "autosync.pause": "Pausieren",
      "autosync.resume": "Fortsetzen",
      "autosync.remove": "Entfernen",
      "autosync.add": "Hinzufügen",
      "autosync.adding": "Wird geprüft ...",
      "autosync.added_series": "Serie zu Auto-Sync hinzugefügt",
      "autosync.added_button": "Hinzugefügt",
      "autosync.no_tracked": "Keine aktiven Serien zum Prüfen.",
      "autosync.mode_fill": "Modus: Lücken füllen. Bei jedem Lauf werden alle verfügbaren fehlenden Folgen der gewählten Sprachfassung eingereiht.",
      "autosync.mode_new": "Modus: Nur Folgen bzw. Sprachfassungen, die nach dem Hinzufügen erschienen sind. Frühere Lücken bleiben unangetastet.",
      ...
      "autosync.search_placeholder": "Serie suchen ...",
      ...
      "autosync.no_matches": "Keine Ergebnisse gefunden.",
